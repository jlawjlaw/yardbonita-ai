...
print("🧪 THIS IS THE RIGHT SCRIPT (v1.2.9)")
...
print("🔧 Running generate_monthly_titles.py v1.2.2 — no cliché filtering applied.")
...
if not needed_rows:
    print("✅ No new articles needed for this month.")
    conn.close()
    sys.exit(0)
