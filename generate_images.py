...
def main():
    ...
    eligible = df[
        ...
        (df["image_filename"].astype(str).str.strip() != "")
    ]
    ...
    print(f"{os.path.splitext(final_filename)[0]}")
    print(f"Please update planning.xlsx for uuid= {uuid} with status='Ready to Upload'")
